...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-6" style="border: 1px solid #FFF;border-color: red">
            <form class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/configuracion_controller/actualizarSucursalFromFormulario" method="post">
                <h4>Modificar Sucursal</h4>
                <input type="hidden" name="idSucursal" id="idSucursal" value="<?php echo $sucursal->{'idSucursal'}; ?>" />

                <div class="form-group">
                    <label class="control-label col-sm-2" for="descripcionSucursal">Sucursal:</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="descripcionSucursal" name="descripcionSucursal" value="<?php echo $sucursal->{'descripcionSucursal'}; ?>" placeholder="Descripci&oacute;n de la Sucursal">
                  </div>					  
                </div>  
