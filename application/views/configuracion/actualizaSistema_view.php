  ...
  <head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function verificaSeleccion() {
            if (document.getElementById('historicoProveedores').checked==false) {
                document.getElementById('criterioHistoricoProveedores').style.display='none';
            } else {
                document.getElementById('criterioHistoricoProveedores').style.display='block';
            }
        }
        ...
        function confirmarCambio(e2) { 
            ...
            //alert(tecla_final2);
            var cadena2 = "" + document.getElementById('ivaEmpresa').value;
            if (tecla_final2==".") {              
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="border: 1px solid #FFF;border-color: red">
            <form onsubmit="javascript: return confirmarCambioSubmit2();" class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/configuracion_controller/actualizarSistemaFromFormulario" method="post">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="tipoOperacion">Tipo de Cambio:</label>
                  <div class="col-sm-10">
                      <select class="form-control col-sm-5" name="tipoOperacion" id="tipoOperacion">
                ...
                <div class="form-group" style="display: none;">
                    <fieldset border="3">
                        ...
                        <div class="checkbox">		
                            <label><input type="checkbox" name="historicoProveedores" id="historicoProveedores" <?php if ($sistema->{'historicoProveedores'}[0]=="1") {
                                echo "checked";	} ?> onclick="verificaSeleccion()"> Trabajar con Historial de Precios de Proveedores</label>
                        </div>
                    </fieldset>	 
                </div> 
                
                <div class="form-group" style="display: none;">
                <label for="criterioHistoricoProveedores">Selecci&oacute;n de Precios para Historial de Precios de Proveedores:</label>
                    <select class="form-control" name="criterioHistoricoProveedores" id="criterioHistoricoProveedores">
                        ...
                        <option <?php if ($sistema->{'criterioHistoricoProveedores'}=="3") {
                                    echo "selected";	} ?> value="3">El m&aacute;s Bajo</option>
                    </select>
                </div>                
                <!-- Fin Para historico de proveedores... queda pendiente -->
                
                <!-- divs de valores a mostrar en el sistema pero se trabajo desde codigo -->
                    <div class="form-group" style="display: none;">
                        <fieldset border="3">
                ...
                <!-- Fin divs de valores a mostrar en el sistema pero se trabajo desde codigo -->
